...
variable "subnet_02_ip" {
  description = "Ip address for a subnet-02"
}
...
variable "subnet_02_secondary_01_ip" {
  description = "Ip address for a subnet-02 secondary range"
}
...
variable "subnet_02_secondary_01_name" {
  description = "Name for a subnet-02 secondary range"
}
...
variable "subnet_02_services_ip" {
  description = "Ip address for a subnet-02 services"
}
